...
function SQLUpdate($sql)
{
	...
	{
		$e = $dbh->errorInfo(); 
		die("<font color=\"red\">SQLUpdate/Delete: Erreur de requete : " . $e[2] . "</font>".$sql);
	}
...
function SQLInsert($sql)
{
	...
	{
		$e = $dbh->errorInfo(); 
		die("<font color=\"red\">SQLInsert: Erreur de requete : " . $e[2] . "</font>".$sql);
	}
...
function SQLGetChamp($sql)
{
	...
	{
		$e = $dbh->errorInfo(); 
		die("<font color=\"red\">SQLGetChamp: Erreur de requete : " . $e[2] . "</font>".$sql);
	}
