...
<html>
					...
					<div class="card">
						<div class="card-header msg_head">
							<div class="d-flex bd-highlight">
								...
								<div class="user_info">
									<span>Chat with '.$coordPatient[0]['nom']." ".$coordPatient[0]['prenom'].'</span>
									<p></p>
								</div>
								')
						...
						foreach ($conversation as $message) {
							...
							<div class="d-flex justify-content-start mb-4">
								<div class="img_cont_msg">
									<img src="https://www.screenfeed.fr/wp-content/uploads/2013/10/default-avatar.png" class="rounded-circle user_img_msg">
								</div>
	...
	<script>
			$(document).ready(function(){
				$('.input-group-text send_btn').click(function(){
				});
			});	
	</script>
